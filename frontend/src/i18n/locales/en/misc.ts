export default {
  ...
  payment: {
    ...
    usdt: {
      ...
      networkWarningTitle: 'IMPORTANT: Network Selection',
      networkWarningDesc: 'Ensure you select {network} when sending. Sending via the wrong network may result in permanent loss of funds.',
      depositAddress: 'Deposit Address',
      amountToSend: 'Amount to Send',
      amountWarningTitle: 'Send EXACT Amount',
      amountWarningUnderpay: 'Underpayment: Refund minus gas fees (~1-2 USDT)',
      amountWarningOverpay: 'Overpayment: Full amount credited (no refund)',
      amountWarningWrongNetwork: 'Wrong network: Funds may be lost permanently',
      paymentStatus: 'Payment Status',
      expiresIn: 'Expires in',
      confirmationProgress: 'Confirmation Progress',
      transactionHash: 'Transaction Hash',
      viewOnExplorer: 'View on Explorer',
      howToPay: 'How to pay with USDT?',
      helpStep1: 'Open your USDT wallet (Binance, OKX, Trust Wallet, etc.)',
      helpStep2: 'Select {network} network for USDT transfer',
      helpStep3: 'Scan the QR code or copy the address and amount',
      helpStep4: 'Confirm the transaction and wait for blockchain confirmation',
