export default {
  ...
  payment: {
    ...
    usdt: {
      ...
      networkFee: '网络费用',
      confirmations: '确认数',
      networkWarningTitle: '重要提示：网络选择',
      networkWarningDesc: '请确保选择 {network} 网络进行转账。使用错误的网络可能导致资金永久丢失。',
      depositAddress: '充值地址',
      amountToSend: '转账金额',
      amountWarningTitle: '请发送精确金额',
      amountWarningUnderpay: '少付：退还金额扣除网络费用（约 1-2 USDT）',
      amountWarningOverpay: '多付：全额到账（不退款）',
      amountWarningWrongNetwork: '错误网络：资金可能永久丢失',
      paymentStatus: '支付状态',
      expiresIn: '剩余时间',
      confirmationProgress: '确认进度',
      transactionHash: '交易哈希',
      viewOnExplorer: '在浏览器查看',
      howToPay: '如何使用 USDT 支付？',
      helpStep1: '打开您的 USDT 钱包（币安、欧易、Trust Wallet 等）',
      helpStep2: '选择 {network} 网络进行 USDT 转账',
      helpStep3: '扫描二维码或复制地址和金额',
      helpStep4: '确认交易并等待区块链确认',
      checkStatus: '检查支付状态',
