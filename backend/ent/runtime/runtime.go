...
func init() {
	...
	cryptodepositaddressFields := schema.CryptoDepositAddress{}.Fields()
	_ = cryptodepositaddressFields
	// cryptodepositaddressDescCurrency is the schema descriptor for currency field.
	cryptodepositaddressDescCurrency := cryptodepositaddressFields[1].Descriptor()
	// cryptodepositaddress.CurrencyValidator is a validator for the "currency" field. It is called by the builders before save.
	cryptodepositaddress.CurrencyValidator = cryptodepositaddressDescCurrency.Validators[0].(func(string) error)
	// cryptodepositaddressDescNetwork is the schema descriptor for network field.
	cryptodepositaddressDescNetwork := cryptodepositaddressFields[2].Descriptor()
	// cryptodepositaddress.NetworkValidator is a validator for the "network" field. It is called by the builders before save.
	cryptodepositaddress.NetworkValidator = cryptodepositaddressDescNetwork.Validators[0].(func(string) error)
	// cryptodepositaddressDescAddress is the schema descriptor for address field.
	cryptodepositaddressDescAddress := cryptodepositaddressFields[3].Descriptor()
	// cryptodepositaddress.AddressValidator is a validator for the "address" field. It is called by the builders before save.
	cryptodepositaddress.AddressValidator = cryptodepositaddressDescAddress.Validators[0].(func(string) error)
	// cryptodepositaddressDescProviderInstanceID is the schema descriptor for provider_instance_id field.
	cryptodepositaddressDescProviderInstanceID := cryptodepositaddressFields[4].Descriptor()
	// cryptodepositaddress.ProviderInstanceIDValidator is a validator for the "provider_instance_id" field. It is called by the builders before save.
	cryptodepositaddress.ProviderInstanceIDValidator = cryptodepositaddressDescProviderInstanceID.Validators[0].(func(string) error)
	// cryptodepositaddressDescStatus is the schema descriptor for status field.
	cryptodepositaddressDescStatus := cryptodepositaddressFields[5].Descriptor()
	// cryptodepositaddress.DefaultStatus holds the default value on creation for the status field.
	cryptodepositaddress.DefaultStatus = cryptodepositaddressDescStatus.Default.(string)
	// cryptodepositaddress.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	cryptodepositaddress.StatusValidator = cryptodepositaddressDescStatus.Validators[0].(func(string) error)
	// cryptodepositaddressDescCreatedAt is the schema descriptor for created_at field.
	cryptodepositaddressDescCreatedAt := cryptodepositaddressFields[6].Descriptor()
	// cryptodepositaddress.DefaultCreatedAt holds the default value on creation for the created_at field.
	cryptodepositaddress.DefaultCreatedAt = cryptodepositaddressDescCreatedAt.Default.(func() time.Time)
	// cryptodepositaddressDescUpdatedAt is the schema descriptor for updated_at field.
	cryptodepositaddressDescUpdatedAt := cryptodepositaddressFields[7].Descriptor()
	// cryptodepositaddress.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	cryptodepositaddress.DefaultUpdatedAt = cryptodepositaddressDescUpdatedAt.Default.(func() time.Time)
	// cryptodepositaddress.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	cryptodepositaddress.UpdateDefaultUpdatedAt = cryptodepositaddressDescUpdatedAt.UpdateDefault.(func() time.Time)
	...
	// paymentorderDescCryptoCurrency is the schema descriptor for crypto_currency field.
	paymentorderDescCryptoCurrency := paymentorderFields[21].Descriptor()
	// paymentorder.CryptoCurrencyValidator is a validator for the "crypto_currency" field. It is called by the builders before save.
	paymentorder.CryptoCurrencyValidator = paymentorderDescCryptoCurrency.Validators[0].(func(string) error)
	// paymentorderDescCryptoNetwork is the schema descriptor for crypto_network field.
	paymentorderDescCryptoNetwork := paymentorderFields[22].Descriptor()
	// paymentorder.CryptoNetworkValidator is a validator for the "crypto_network" field. It is called by the builders before save.
	paymentorder.CryptoNetworkValidator = paymentorderDescCryptoNetwork.Validators[0].(func(string) error)
	// paymentorderDescCryptoAddress is the schema descriptor for crypto_address field.
	paymentorderDescCryptoAddress := paymentorderFields[23].Descriptor()
	// paymentorder.CryptoAddressValidator is a validator for the "crypto_address" field. It is called by the builders before save.
	paymentorder.CryptoAddressValidator = paymentorderDescCryptoAddress.Validators[0].(func(string) error)
	// paymentorderDescCryptoTxHash is the schema descriptor for crypto_tx_hash field.
	paymentorderDescCryptoTxHash := paymentorderFields[24].Descriptor()
	// paymentorder.CryptoTxHashValidator is a validator for the "crypto_tx_hash" field. It is called by the builders before save.
	paymentorder.CryptoTxHashValidator = paymentorderDescCryptoTxHash.Validators[0].(func(string) error)
	// paymentorderDescCryptoConfirmations is the schema descriptor for crypto_confirmations field.
	paymentorderDescCryptoConfirmations := paymentorderFields[25].Descriptor()
	// paymentorder.DefaultCryptoConfirmations holds the default value on creation for the crypto_confirmations field.
	paymentorder.DefaultCryptoConfirmations = paymentorderDescCryptoConfirmations.Default.(int)
