...
const (
	...
	// EdgeCryptoDepositAddresses holds the string denoting the crypto_deposit_addresses edge name in mutations.
	EdgeCryptoDepositAddresses = "crypto_deposit_addresses"
	...
	// CryptoDepositAddressesTable is the table that holds the crypto_deposit_addresses relation/edge.
	CryptoDepositAddressesTable = "crypto_deposit_addresses"
	// CryptoDepositAddressesInverseTable is the table name for the CryptoDepositAddress entity.
	// It exists in this package in order to avoid circular dependency with the "cryptodepositaddress" package.
	CryptoDepositAddressesInverseTable = "crypto_deposit_addresses"
	// CryptoDepositAddressesColumn is the table column denoting the crypto_deposit_addresses relation/edge.
	CryptoDepositAddressesColumn = "user_id"
...
// ByCryptoDepositAddressesCount orders the results by crypto_deposit_addresses count.
func ByCryptoDepositAddressesCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newCryptoDepositAddressesStep(), opts...)
	}
}

// ByCryptoDepositAddresses orders the results by crypto_deposit_addresses terms.
func ByCryptoDepositAddresses(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newCryptoDepositAddressesStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newCryptoDepositAddressesStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CryptoDepositAddressesInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, CryptoDepositAddressesTable, CryptoDepositAddressesColumn),
	)
}
