...
type UserEdges struct {
	...
	// CryptoDepositAddresses holds the value of the crypto_deposit_addresses edge.
	CryptoDepositAddresses []*CryptoDepositAddress `json:"crypto_deposit_addresses,omitempty"`
...
// CryptoDepositAddressesOrErr returns the CryptoDepositAddresses value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) CryptoDepositAddressesOrErr() ([]*CryptoDepositAddress, error) {
	if e.loadedTypes[13] {
		return e.CryptoDepositAddresses, nil
	}
	return nil, &NotLoadedError{edge: "crypto_deposit_addresses"}
}
...
// QueryCryptoDepositAddresses queries the "crypto_deposit_addresses" edge of the User entity.
func (_m *User) QueryCryptoDepositAddresses() *CryptoDepositAddressQuery {
	return NewUserClient(_m.config).QueryCryptoDepositAddresses(_m)
}
