...
func SetupRouter(
	...
	r.Use(middleware2.GeoBlock(settingService))
...
func registerRoutes(
	...
	routes.RegisterPaymentRoutes(v1, h.Payment, h.PaymentWebhook, h.Admin.Payment, h.USDTPayment, jwtAuth, adminAuth, auditLog, settingService, panelRateLimiter)
